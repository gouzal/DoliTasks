...
/**
 * \file    test/functional/DoliTasksFunctionalTest.php
 * \ingroup dolitasks
 ...
 *
 * @package Testdolitasks
 */
class DoliTasksFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoliTasks')->click();
		} else {
			// Disable the module
			$this->byHref('modDoliTasks')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/dolitasks/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolitasks/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolitasks/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolitasks/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolitaskswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliTasks_DoliTasksTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliTasks_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
