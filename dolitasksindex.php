...
/**
 *	\file       htdocs/dolitasks/template/dolitasksindex.php
 *	\ingroup    dolitasks
 *	\brief      Home page of dolitasks top menu
 */
...
$langs->loadLangs(array("dolitasks@dolitasks"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->dolitasks->read) accessforbidden();
...
llxHeader("",$langs->trans("DoliTasksArea"));
