...
/**
 * \file        class/my_tasks.class.php
 * \ingroup     dolitasks
 * \brief       This file is a CRUD class file for my_tasks (Create/Read/Update/Delete)
 */
 ...
 * Class for my_tasks
 */
class my_tasks extends CommonObject
{
	/**
	 * @var string ID to identify managed object
	 */
	public $element = 'my_tasks';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'dolitasks_my_tasks';

	/**
	 * @var int  Does my_tasks support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;

	/**
	 * @var int  Does my_tasks support extrafields ? 0=No, 1=Yes
	 */
	public $isextrafieldmanaged = 1;

	/**
	 * @var string String with name of icon for my_tasks. Must be the part after the 'object_' into object_my_tasks.png
	 */
	public $picto = 'my_tasks@dolitasks';
...
/*	public $fields=array(
	 ...
	 */
	//public $table_element_line = 'my_tasksdet';

	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_my_tasks';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'my_tasksline';

	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('my_tasksdet');

	/**
	 * @var my_tasksLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object my_tasksLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("my_tasks") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/dolitasks/my_tasks_card.php',1).'?id='.$this->id;
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("Showmy_tasks");
            ...
            /*
             $hookmanager->initHooks(array('my_tasksdao'));
...
/**
 * Class my_tasksLine. You can also remove this and generate a CRUD class for lines objects.
 */
/*
class my_tasksLine
{
