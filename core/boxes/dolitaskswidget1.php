...
/**
 * \file    modulebuilder/template/core/boxes/dolitaskswidget1.php
 * \ingroup dolitasks
 * \brief   Widget provided by DoliTasks
 *
 ...
 */
class dolitaskswidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "dolitasksbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "dolitasks@dolitasks";
	 ...
	 */
	public $depends = array('dolitasks');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->dolitasks->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//include_once DOL_DOCUMENT_ROOT . "/dolitasks/class/dolitasks.class.php";

		// Populate the head at runtime
		$text = $langs->trans("DoliTasksBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_dolitasks@dolitasks',
