...
/**
 * mailing_mailinglist_dolitasks
 */
class mailing_mailinglist_dolitasks_myobject extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	var $name='mailinglist_dolitasks_myobject';
	...
	function __construct($db)
	{
		...
		{
			$this->enabled=in_array('dolitasks',$conf->modules)?1:0;
		}
	}
	...
	function url($id)
	{
		return '<a href="'.dol_buildpath('/dolitasks/myobject_card.php',1).'?id='.$id.'">'.img_object('',"generic").'</a>';
	}
	...
	function add_to_target($mailing_id,$filtersarray=array())
	{
		...
		if ($result)
		{
			...
			dol_syslog("mailinglist_dolitasks_myobject.modules.php: mailing ".$num." targets found");
